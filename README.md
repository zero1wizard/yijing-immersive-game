...
易境是一个用 Vite + React + TypeScript 构建的单页可游玩产品原型。它不把《易经》包装成“给答案”的工具，而是把六十四卦重组为可进入的情境节点，让用户通过遭遇、选择、转卦、记录与回看，练习判断与反思。

## 当前版本

**v0.2** 的重点不是继续堆卦，而是把“单次推演”推进到“连续修习”：

- 新增 **7 日修习路径**：从今日一卦扩展成连续 7 天的反思入口
- 新增 **修习档案**：查看最近章节重心、反复出现的主题、日课与推演次数
- 新增 **下一步建议**：基于当前卦境、相关卦和未遭遇内容做轻量推荐
- 保留原有核心循环：遭遇 -> 选择 -> 动爻 -> 转卦 -> 札记 -> 回看
...
5. 用七日修习路径形成连续反思，再回看自己的章节偏向与主题复现。
6. 在卦典中检索其他卦，并写下个人札记。
